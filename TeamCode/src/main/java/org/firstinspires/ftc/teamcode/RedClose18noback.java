...
@Autonomous(name = "Red Close 18 no back spike")
@Configurable
public class RedClose18noback extends OpMode {
                ...
                if (!follower.isBusy()) {
                    ...
                    if (pathTimer.getElapsedTime() > 817) {
                        ...
                        if (pathState == 10) {
                            ...
                            // After Gate Cycle 2, run Gate Cycle 3
                            ...
                            // After grabCycle2, head straight to park (Skipping Ground Cycle 3)
