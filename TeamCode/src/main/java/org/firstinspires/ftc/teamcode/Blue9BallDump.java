...
@Autonomous(name = "Blue 9 Ball Auto", group = "9")
public class Blue9BallDump extends OpMode {
...
//    }
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        moveover = follower.pathBuilder()
                .addPath(new BezierLine(pickup1Pose, pickup3StartPose))
                .setLinearHeadingInterpolation(pickup1Pose.getHeading(), pickup3StartPose.getHeading())
                .build();
        ...
        getout12 = follower.pathBuilder()
                .addPath(new BezierLine(pickup3EndPose, pickup1Pose))
            ...
            */
            ...
            case 3:
                ...
                if (follower.isBusy()) {
                    ...
                    follower.followPath(getout1, true);
                    setPathState(3001); // Move to a "wait for score" state
                }
                break;
            ...
            case 3001:
                ...
                if (!follower.isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are scoring the sample */
                    follower.followPath(moveover,true);
                    setPathState(3002);
                }
                break;
            ...
            case 3003:
                ...
                if (!follower.isBusy()) {
                    ...
                    /* Since this is a pathChain, we can have Pedro hold the end point while we are scoring the sample */
                    follower.followPath(getout12,true);
                    setPathState(301);
                }
                break;
