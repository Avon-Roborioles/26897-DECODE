...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = .00295514;
//            8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    //.01631046
    public static double STRAFE_TICKS_TO_INCHES = .00295    ;
        //8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        // X value: .875
        // Y-Value: 2.6060
        forwardEncoderPose = new Pose(4.0620, 3.2735, 0);
        strafeEncoderPose = new Pose(.875, 2.6060, Math.toRadians(90));
        ...
        // Direction expected v.s real direction

        // TODO: replace these with your encoder ports
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "flymotor1"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "flymotor2"));
