...
public class virtualField extends OpMode {
    ...
    // --- CONFIGURE THESE TO MATCH YOUR HARDWARE & FIELD ---
    ...
    private boolean poseLocked = false; // for init-loop pose selection
    ...
    public void loop() {
        ...
        double imuHeading = o.firstAngle;
