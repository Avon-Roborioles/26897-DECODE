...
//
//@Autonomous(name = "Blue 12 Ball Auto", group = "12")
...
//    private final Pose pickup3StartPose = new Pose(25, -101.5, Math.toRadians(180));
//    private final Pose pickup3EndPose = new Pose(-7.23, -101.5, Math.toRadians(180));
